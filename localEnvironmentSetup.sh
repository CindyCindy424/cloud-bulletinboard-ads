...
export VCAP_SERVICES='{"postgresql-9.3":[{"name":"postgresql-lite","label":"postgresql-9.3","credentials":{"dbname":"test","hostname":"127.0.0.1","password":"jlxXL0424","port":"5432","uri":"postgres://postgres:jlxXL0424@localhost:5432/test","username":"postgres"},"tags":["relational","postgresql"],"plan":"free"}]}'
